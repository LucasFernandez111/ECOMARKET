  ...
  return (
    <nav className="bg-lime-600 fixed w-full shadow-md rounded-lg  z-50  top-0 start-0 border-b border-gray-200 ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex  md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse text-center text-white gap-9 items-center justify-center text-xl  font-semibold">
